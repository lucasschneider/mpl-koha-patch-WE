...
function parseBadAddr() {
  var addr = document.getElementById('address'),
    ...
    unacceptable = [
      ...
      new Address("115 w(est)? doty s", "115 W Doty St", "Dane County Jail"),
      new Address("4230 e(ast)? towne b", "4230 E Towne Blvd", "PO Boxes/Mail Services"),
      new Address("6441 enterprise l", "6441 Enterprise Ln", "PO Boxes/Mail Services"),
      new Address("2935 fish hatchery r", "2935 Fish Hatchery Rd", "PO Boxes/Mail Services"),
      new Address("802 e(ast)? gorham s", "802 E Gorham St", "Yahara House"),
      new Address("408 w(est)? gorham s", "408 W Gorham St", "Social Club"),
      ...
      new Address("1206 northport d", "1206 Northport Dr", "Dane County Social Services"),
      new Address("6666 odana r", "6666 Odana Rd", "PO Boxes/Mail Services"),
      new Address("128 e(ast)? olin a", "128 E Olin Ave", "Family Service Madison"),
      new Address("1228 s(outh)? park s", "1228 S Park St", "Dane County Housing Authority"),
      new Address("1240 s(outh)? park s", "1240 S Park St", "Housing Service"),
      new Address("1360 regent s", "1360 Regent St", "PO Boxes/Mail Services"),
      new Address("2120 rimrock r", "2120 Rimrock Rd", "Dane County Jail"),
      new Address("3150 st paul a", "3150 St Paul Ave", "DoC Housing - 2 Week Stay"),
      new Address("103 s(outh)? (second|2nd) s", "103 S Second St", "Mail Service"),
      new Address("1213 n(orth)? sherman a", "1213 N Sherman Ave", "PO Boxes/Mail Services"),
      new Address("731 state s", "731 State St", "Pres House"),
      new Address("2701 university a", "2701 University Ave", "PO Boxes/Mail Services"),
      new Address("322 e(ast)? washington a", "322 E Washington Ave", "St John's Lutheran Church"),
      new Address("512 e(ast)? washington a", "512 E Washington Ave", "Probation/Parole"),
      new Address("1245 e(ast)? washinton a", "1245 E Washington Ave", "Advocacy Offices"),
      new Address("116 w(est)? washington a", "116 W Washington Ave", "Grace Episcopal Church"),
      new Address("625 w(est)? washington a", "625 W Washington Ave", "Meriter Health Center"),
      new Address("668 w(est)? washington a", "668 W Washington Ave", "Mail Service")
    ],
    restricted = [
      new Address("221 s(outh)? baldwin s", "221 S Baldwin St", "Port St Vincent"),
      new Address("141 s(outh)? butler s", "141 S Butler St", "Hostelling International - Madison"),
      new Address("2009 e(ast)? dayton s", "2009 E Dayton St", "ARC Dayton"),
      new Address("4117 dwight d", "4117 Dwight Dr", "Dwight Halfway House"),
      new Address("300 femrite d", "300 Femrite Dr", "Telurian"),
      new Address("4 n(orth)? hancock s", "4 N Hancock St", "Off Square Club"),
      new Address("3501 kipling d", "3501 Kipling Dr", "Schwert Halfway House"),
      new Address("4202 monona d", "4202 Monona Dr", "ARC Maternal Infant Program"),
      new Address("4006 nakoosa t", "4006 Nakoosa Trl", "Porchlight/Safe Haven"),
      new Address("422 n(orth)? s", "422 North St", "Arise Family Services"),
      new Address("5706 odana r", "5706 Odana Rd", "Foster Halfway House"),
      new Address("810 w(est)? olin a", "810 W Olin Ave", "Rebos Chris Farley House"),
      new Address("202 n(orth)? patt?erson s", "202 N Paterson St", "ARC Patterson"),
      new Address("2720 rimrock r", "2720 Rimrock Rd", "Youth Services of Southern Wisconsin"),
      new Address("312 wisconsin a", "312 Wisconsin Ave", "Bethel Lutheran Church"),
      new Address("1301 williamson s", "1301 Williamson St", "Port St Vincent")
    ],
    addrRegExFirst = /^[ ]*/,
    addrRegExLast = /.*/,
