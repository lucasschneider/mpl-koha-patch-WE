...
availableSinceSort.addEventListener('click',function() {updateHoldTable(waitingHolds);});
...
heldThroughSort.addEventListener('click',function() {updateHoldTable(waitingHolds);});
