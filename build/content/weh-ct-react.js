...
(function () {
    ...
    function wehReactAttach(component, callback) {
        ...
        component.componentDidMount = function () {
            ...
            if (previous.componentDidMount) previous.componentDidMount.apply(component, arguments);
        };
        component.componentWillUnmount = function () {
            weh.off(receiveCallback);
            if (previous.componentWillUnmount) previous.componentWillUnmount.apply(component, arguments);
        };
    }
