...
(function () {
  ...
  function fillDormExp() {
    var addr = document.getElementById('address'),
        ...
        dormAddr = [new Address("625 babcock", "Slichter Hall"), new Address("625 elm", "Cole Hall"), new Address("635 elm", "Sullivan Hall"), new Address("640 elm", "DeJope Hall"), new Address("650 elm", "Bradley Hall"), new Address("1635 kronshage", "Leopold Hall"), new Address("1650 kronshage", "Kronshage Hall"), new Address("420 n(orth)? park", "Chadbourne Residential College"), new Address("35 n(orth)? park", "Smith Hall"), new Address("1200 observatory", "Elizabeth Waters Hall"), new Address("1510 tripp", "Tripp Hall"), new Address("1520 tripp", "Adams Hall"), new Address("970 university", "Barnard Hall"), new Address("835 w(est)? dayton", "Ogg Hall"), new Address("9(1(7|9)|21) w(est)? dayton", "Merit House"), new Address("615 w(est)? johnson", "Witte Hall"), new Address("821 w(est)? johnson", "Sellery Hall"), new Address("917 w(est)? johnson", "Susan B. Davis"), new Address("1950 willow", "Phillips Hall")],
        addrRegExFirst = /[ ]*/,
        addrRegExLast = /.*/,
