...
if (/^https?\:\/\/scls-staff\.kohalibrary\.com\/cgi-bin\/koha\/members\/memberentry\.pl.*/.test(location.href)) {
  ...
  var unusedFields = ['streetnumber', 'address2', 'select_city', 'country', 'mobile', 'emailpro', // Secondary email address
  'fax', 'B_country', 'B_address2', 'altcontactcountry', 'altcontactaddress2', 'sort2', 'email6', // Item checkout notification
  ...
  'patron_attr_1', 'patron_attr_2', 'patron_attr_3', 'patron_attr_4', 'patron_attr_5', 'patron_attr_6', 'patron_attr_7', 'patron_attr_8', 'patron_attr_9', 'patron_attr_10', 'patron_attr_11'],
      unused4WebUse = ['phone', 'phonepro', 'email', 'B_address', 'B_city', 'B_zipcode', 'B_phone', 'B_email', 'altcontactsurname', 'altcontactfirstname', 'altcontactaddress1', 'altcontactaddress3', 'altcontactzipcode', 'altcontactphone'],
