...
(function () {
  ...
  function sortTable(itemHistoryEntries, sortCode, limitBarcode) {
    ...
    switch (sortCode) {
      ...
      case "dueASC":
        itemHistoryEntries.sort(function (a, b) {
          if (groupItems && groupItems.checked) {
            if (a.owningLibrary < b.owningLibrary) return -1;else if (a.owningLibrary > b.owningLibrary) return 1;else if (a.barcode < b.barcode) return -1;else if (a.barcode > b.barcode) return 1;
          }
          if (a.dueDate < b.dueDate) return -1;else if (a.dueDate > b.dueDate) return 1;else if (a.name < b.name) return -1;else if (a.name > b.name) return 1;else return 0;
        });
        break;
      // Due date, DESC
      case "dueDESC":
        itemHistoryEntries.sort(function (a, b) {
          ...
          if (b.dueDate < a.dueDate) return -1;else if (b.dueDate > a.dueDate) return 1;else if (a.name < b.name) return -1;else if (a.name > b.name) return 1;else return 0;
        });
        break;
      // Return date, ASC
      case "returnASC":
        itemHistoryEntries.sort(function (a, b) {
          ...
          if (a.returnDate < b.returnDate) return -1;else if (a.returnDate > b.returnDate) return 1;else if (a.name < b.name) return -1;else if (a.name > b.name) return 1;else return 0;
        });
        break;
      // Return date, DESC
      case "returnDESC":
        itemHistoryEntries.sort(function (a, b) {
          ...
          if (b.returnDate < a.returnDate) return -1;else if (b.returnDate > a.returnDate) return 1;else if (a.name < b.name) return -1;else if (a.name > b.name) return 1;else return 0;
        });
        break;
      // Checkout date, ASC
      case "checkoutASC":
        itemHistoryEntries.sort(function (a, b) {
          ...
          if (a.date < b.date) return -1;else if (a.date > b.date) return 1;else if (a.name < b.name) return -1;else if (a.name > b.name) return 1;else return 0;
        });
        break;
      // Checkout date, DESC
      case "checkoutDESC":
      default:
        itemHistoryEntries.sort(function (a, b) {
          ...
          if (b.date < a.date) return -1;else if (b.date > a.date) return 1;else if (a.name < b.name) return -1;else if (a.name > b.name) return 1;else return 0;
        });
    }
    ...
    if (groupItems && groupItems.checked && limitBarcode.length !== 14) {
      itemHistoryEntries.sort(function (a, b) {
        ...
        if (b.owningLibrary === libCode && a.owningLibrary !== libCode) return 1;else return 0;
      });
    }
    ...
    try {
      for (var _iterator = itemHistoryEntries[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var trObj = _step.value;
  ...
  if (historyTable && h1Elts) {
    ...
    if (itemRowArray && itemRowArray.length > 1) {
      ...
      try {
        for (var _iterator2 = itemRowArray[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var tr = _step2.value;
    ...
    try {
      for (var _iterator3 = document.getElementById('sortOptions').children[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        var td = _step3.value;
        ...
        td.addEventListener('click', function () {
          ...
          if (this.className !== "selectedSort") {
            ...
            try {
              for (var _iterator4 = document.getElementById('sortOptions').children[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                var td = _step4.value;
