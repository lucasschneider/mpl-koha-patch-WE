  ...
  switch (sortCode) {
    default:
      waitingHolds.sort(function (a, b) {
        if (a.expirationDate < b.expirationDate) return -1;else if (a.expirationDate > b.expirationDate) return 1;else if (a.patronLast < b.patronLast) return -1;else if (a.patronLast > b.patronLast) return 1;else if (a.title < b.title) return -1;else if (a.title > b.title) return 1;else return 0;
      });
      break;
  }
