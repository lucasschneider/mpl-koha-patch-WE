...
switch (startDate.split("/")[0]) {
	case "01":
		dr1Month.value = "1";break;
	case "02":
		dr1Month.value = "2";break;
	case "03":
		dr1Month.value = "3";break;
	case "04":
		dr1Month.value = "4";break;
	case "05":
		dr1Month.value = "5";break;
	case "06":
		dr1Month.value = "6";break;
	case "07":
		dr1Month.value = "7";break;
	case "08":
		dr1Month.value = "8";break;
	case "09":
		dr1Month.value = "9";break;
	default:
		dr1Month.value = startDate.split("/")[0];break;
}

switch (startDate.split("/")[1]) {
	case "01":
		dr1Day.value = "1";break;
	case "02":
		dr1Day.value = "2";break;
	case "03":
		dr1Day.value = "3";break;
	case "04":
		dr1Day.value = "4";break;
	case "05":
		dr1Day.value = "5";break;
	case "06":
		dr1Day.value = "6";break;
	case "07":
		dr1Day.value = "7";break;
	case "08":
		dr1Day.value = "8";break;
	case "09":
		dr1Day.value = "9";break;
	default:
		dr1Day.value = startDate.split("/")[1];break;
}
...
switch (endDate.split("/")[0]) {
	case "01":
		dr2Month.value = "1";break;
	case "02":
		dr2Month.value = "2";break;
	case "03":
		dr2Month.value = "3";break;
	case "04":
		dr2Month.value = "4";break;
	case "05":
		dr2Month.value = "5";break;
	case "06":
		dr2Month.value = "6";break;
	case "07":
		dr2Month.value = "7";break;
	case "08":
		dr2Month.value = "8";break;
	case "09":
		dr2Month.value = "9";break;
	default:
		dr2Month.value = endDate.split("/")[0];break;
}

switch (endDate.split("/")[1]) {
	case "01":
		dr2Day.value = "1";break;
	case "02":
		dr2Day.value = "2";break;
	case "03":
		dr2Day.value = "3";break;
	case "04":
		dr2Day.value = "4";break;
	case "05":
		dr2Day.value = "5";break;
	case "06":
		dr2Day.value = "6";break;
	case "07":
		dr2Day.value = "7";break;
	case "08":
		dr2Day.value = "8";break;
	case "09":
		dr2Day.value = "9";break;
	default:
		dr2Day.value = endDate.split("/")[1];break;
}
